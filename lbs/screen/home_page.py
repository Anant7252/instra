...
import json
from lbs.components.post_card import PostCard

from lbs.components.circular_avatar_image import CircularAvatarImage
...
class HomePage(MDScreen):
    ...
    def list_stories(self):
        with open('assests/data/stories.json') as f_obj:
    ...
    def list_posts(self):
        with open('assests/data/posts.json') as f_obj:
            data = json.load(f_obj)
